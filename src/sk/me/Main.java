...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Run FilterPatternDemo
        System.out.println("***Begin FilterPatternDemo***");
        FilterPatternDemo.main(new String[]{});
        System.out.println("***End FilterPatternDemo***\n\n");
        // Run CompositePatternDemo
